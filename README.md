...
Sweeps can be recorded on real hardware or with an emulator. If the play time is at least 1 second at 44.1kHz, one can automate frecuency detection, for example with aubiopitch of the [aubio](https://aubio.org/) project.
